...
// Configuration
const apikey = 'ptla_F12oJPNJ98l6kubOsKFEa1yAXQQmnPXebvrrrbVkYF7';
const capikey = 'ptlc_sHFLCaGUUthPOwVJo4cZvyurMRcpLDTuFIhJTyTysqI';
const domain = 'https://indonesiaemas.rismajaya.shop';
const nestid = '5';
const egg = '15';
const loc = '1';
const gmailadmin = 'admin@gmail.com'; // Admin email that won't be deleted
const telegramBotToken = '8415226642:AAFEilae16UeSVgcXJOAgu0ZDjjlB7rZB_k';
const adminTelegramId = '7726353539';
